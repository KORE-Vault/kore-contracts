...
interface IFeeApprover {
    ...
    function setKoreTokenAddress(address _koreTokenAddress) external;
...
contract NBUNIERC20 is Context, INBUNIERC20, Ownable {
    ...
    string public liquidityGenerationParticipationAgreement = "I agree that the developers and affiliated parties of the Kore team are not responsible for your funds";
    ...
    function _transfer(
        ...
        if(transferToFeeDistributorAmount > 0 && feeDistributor != address(0)){
            ...
            if(feeDistributor != address(0)){
                IKoreVault(feeDistributor).addPendingRewards(transferToFeeDistributorAmount);
            }
        }
    }
