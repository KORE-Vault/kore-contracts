...
contract FeeApprover is OwnableUpgradeSafe {
    ...
    function initialize(
        address _KOREAddress,
        address _WETHAddress,
        address _koreVaultAddress
    ) public initializer {
        OwnableUpgradeSafe.__Ownable_init();
        koreTokenAddress = _KOREAddress;
        WETHAddress = _WETHAddress;
        tokenUniswapPair = IUniswapV2Factory(address(0x5C69bEe701ef814a2B6a3EDD4B1652CB9cc5aA6f)).getPair(WETHAddress,koreTokenAddress);
        koreVaultAddress = _koreVaultAddress;
        feePercentX100 = 15;
    ...
    address koreTokenAddress;
    address koreVaultAddress;
    ...
    function setKoreVaultAddress(address _koreVaultAddress) public onlyOwner {
        koreVaultAddress = _koreVaultAddress;
    }
        ...
        )
    {
        ...
        // Dont have a fee when koreVault is sending, or infinite loop
        // And when pair is sending ( buys are happening, do not tax on it)
        if(sender == koreVaultAddress || sender == tokenUniswapPair ) {
